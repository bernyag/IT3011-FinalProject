...
# load dataset
file = np.genfromtxt('good.csv', delimiter=',')
...
X_train = X_train.reshape((X_train.shape[0], 45, 45, 1)).astype('float32')
X_test = X_test.reshape((X_test.shape[0], 45, 45, 1)).astype('float32')
